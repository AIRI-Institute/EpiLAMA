...
from SWAT.src.layers.regression_head import RegressionHead
from SWAT.src.layers.transformer_stack import TransformerStack
from SWAT.src.sdk.api import (
    ESMCInferenceClient,
    ESMProtein,
    ESMProteinTensor,
    ForwardTrackData,
...
from SWAT.src.tokenization import EsmSequenceTokenizer
from SWAT.src.utils import encoding
from SWAT.src.utils.constants.models import ESMC_600M
from SWAT.src.utils.decoding import decode_sequence
from SWAT.src.utils.misc import stack_variable_length_tensors
from SWAT.src.utils.sampling import _BatchedESMProteinTensor
...
class ESMCfloat32(nn.Module, ESMCInferenceClient):
    """
    ...
    def from_pretrained(
        ...
        from SWAT.src.pretrained import load_local_model
